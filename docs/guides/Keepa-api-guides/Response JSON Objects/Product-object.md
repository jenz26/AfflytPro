...

{
    ...
    Deal Details Object fields
        ...
        startTime — Integer
        Deal start in Keepa Time minutes. Not available for all deal types.

        endTime — Integer
        Deal end in Keepa Time minutes. Not available for all deal types.

        percentClaimed — Integer
        Percentage claimed indicator for Lightning Deals (LIMITED_TIME_DEAL).
