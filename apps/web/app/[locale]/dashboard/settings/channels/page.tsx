...
export default function ChannelsPage() {
    ...
    // Calculate stats
    const totalPosts = channels.reduce((sum, c) => sum + (c.stats?.totalPosts || 0), 0);
    const totalClicks = channels.reduce((sum, c) => sum + (c.stats?.totalClicks || 0), 0);
            ...
            <div className="border-b border-afflyt-glass-border bg-afflyt-dark-50/50 backdrop-blur-xl">
                <div className="px-8 py-6">
                    <div className="flex items-center justify-between">
                        ...
                        {/* Stats & Add Button (when channels exist) */}
                        {!isFirstTime && (
