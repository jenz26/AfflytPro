...
export function AIInsights({ insights, score, summary, loading }: AIInsightsProps) {
    const t = useTranslations('analytics.aiInsights');
        ...
        <div className="space-y-6">
            ...
            <GlassCard className="p-6">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-white">{t('healthScore')}</h3>
                        <p className="text-sm text-gray-400">{t('healthScoreDesc')}</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <span className="text-sm text-gray-400">{t('outOf')}</span>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 grid grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div className="p-4 bg-white/5 rounded-lg">
                            <p className="text-xs text-gray-400 mb-1">{t('cvr')}</p>
                            <p className="text-xl font-bold text-white">{summary.cvr}%</p>
                        </div>
                        <div className="p-4 bg-white/5 rounded-lg">
                            <p className="text-xs text-gray-400 mb-1">{t('insightsFound')}</p>
            ...
            <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-400">{t('insightsCount', { count: insights.length })}</span>
            </div>
            ...
            {insights.length === 0 ? (
                <GlassCard className="p-8 text-center">
                    ...
                    <h4 className="text-white font-semibold mb-2">{t('allGood')}</h4>
            ...
            {/* Pro Tip */}
            <GlassCard className="p-4 bg-linear-to-r from-purple-500/10 to-pink-500/10 border-purple-500/20">
                <div className="flex items-center gap-3">
                    <Sparkles className="w-5 h-5 text-purple-400 shrink-0" />
                    <p className="text-sm text-gray-300">
                        <span className="text-purple-400 font-medium">{t('proTip')}:</span> {t('proTipText')}
                    </p>
                </div>
            </GlassCard>
        </div>
